...
<div class="container">
    ...
    <div style="float: left;">
        ...
        <form class="form-inline" action="${pageContext.request.contextPath}/findUserByPageServlet" method="post">
            ...
            <div class="form-group">
                <label for="exampleInputAddress3">籍贯</label>
                <input name="address" value="${condition.address[0]}" type="text" class="form-control"
                       id="exampleInputAddress3">
            </div>

            <div class="form-group">
                <label for="exampleInputEmail2">邮箱</label>
                <input name="email" value="${condition.email[0]}" type="text" class="form-control"
